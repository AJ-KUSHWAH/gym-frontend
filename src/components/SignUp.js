...
const handleSubmit = async (e) => {
  ...
  if (!formData.name || !formData.password || !formData.email || !formData.description || !formData.location || !formData.ownerName || !formData.gymName) {
    toast({
...
const saveFormData = async ({name,email,password,gymName,ownerName,description,location,photos}) => {

  try {
      
    console.log({name,email,password,gymName,ownerName,description,location,photos});
    ...
    const { data } = await axios.post("/api/user", {
      name, email,password,gymName,ownerName,description,location,photos
    }, config);
